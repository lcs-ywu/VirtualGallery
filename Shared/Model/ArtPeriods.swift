...
""", works: ["Cimabue - Crucifix, 1288", "Giotto - Lamentation of Christ, 1305"], contributors: "Abbot Suger, Cimabue, Giotto"))
        ...
        periods.append(Period(name: "Surrealism", characteristics: "Exploration of dreams and unconsciousness, inspired by Sigmund Freud", artists: [getArtist(named: "Salvador Dalí")], time: "A.D. 1917–A.D. 1950", description: """
        ...
        periods.append(Period(name: "Abstract Expressionism", characteristics: "Spontaneity, improvisation, colossally scaled works, unique techniques", artists: [getArtist(named: "Jackson Pollock")], time: "A.D. 1940–A.D. 1950s", description: """
