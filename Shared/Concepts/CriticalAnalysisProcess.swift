...
struct CriticalAnalysisProcess: View {
    var body: some View {
        Group {
            ...
            HStack {
                Text("Type of Art Criticism").bold().font(.system(.title, design: .serif)).padding(.all)
                Spacer()
            }
        ...
        Group {
            HStack {
                Text("Professional Criticism").font(.system(.title, design: .serif)).padding(.all)
                Spacer()
            }
            HStack {
                Text("""
            ...
            HStack {
                Text("Non-Professional Criticism").font(.system(.title, design: .serif)).padding(.all)
                Spacer()
            }
            HStack {
                Text("""
